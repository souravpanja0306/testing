...
const Address = () => {
    return (
        ...
        <Layout>
            <Link to="/invitation" className="fixed bottom-[40%] left-0" onClick={() => navigator.vibrate(75)}>
            ...
            <Link to="/" className="fixed bottom-[40%] right-0" onClick={() => navigator.vibrate(75)}>
